...
function Education() {
  ...
  const educationSection= useSelector(state=>state.educationSection)
  const contactSection=useSelector(state=>state.contactSection)
  ...
  const onSubmit = async(e) => {
    ...
    if(educationSection!=null){
        ...
        dispatch(educationActions.update(education));
      }else{
        // props.addEducation(props.document.id,education);
        dispatch(educationActions.add(education));
    }
      ...
      <div className="container med education" >
        <div className="section funnel-section">
          ...
          <div className="preview-card">
            ...
            <ResumePreview contactSection={contactSection} educationSection={education} skinCd={document?.skinCd}></ResumePreview>            
          </div>
        </div>
      </div>
    );
